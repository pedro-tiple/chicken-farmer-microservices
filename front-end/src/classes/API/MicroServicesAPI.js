...
export default class MicroServicesAPI {
  ...
  async getGoldEggs() {
    return await axios.get(`${this.USER_MS_URL}/getGoldEggs`, await this.getJwtTokenConfig());
  }

  async registerNewBarn() {
    return await axios.get(`${this.BARN_MS_URL}/buy`, await this.getJwtTokenConfig());
  }
  ...
  async buyAutoFeeder(barndId) {
    return await axios.get(`${this.BARN_MS_URL}/${barndId}/buy/autoFeeder`, await this.getJwtTokenConfig());
  }

  async buyFeed(barndId) {
    return await axios.get(`${this.BARN_MS_URL}/${barndId}/buy/feed`, await this.getJwtTokenConfig());
  }
  ...
  async feedChicken(chickenId) {
    return await axios.get(`${this.CHICKEN_MS_URL}/${chickenId}/feed`, await this.getJwtTokenConfig());
  }

  async bulkFeedChicken(chickenIds) {
    return await axios.post(`${this.CHICKEN_MS_URL}/bulkFeed`, {chickenIds}, await this.getJwtTokenConfig());
  }

  async buyChicken(barndId) {
    return await axios.get(`${this.CHICKEN_MS_URL}/buy/${barndId}`, await this.getJwtTokenConfig());
  }

  async sellChicken(chickenId) {
    return await axios.get(`${this.CHICKEN_MS_URL}/${chickenId}/sell`, await this.getJwtTokenConfig());
  }
}