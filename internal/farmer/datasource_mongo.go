...
func ProvideMongoDatabase(ctx context.Context) (*MongoDatabase, error) {
	...
	clientOptions := options.Client().ApplyURI("mongodb://admin:password@barnsvc-mongodb:27017")
...
func (m MongoDatabase) InsertFarmer(ctx context.Context, farmer Farmer) (farmerID uuid.UUID, err error) {
	//TODO implement me
	panic("implement me")
}
