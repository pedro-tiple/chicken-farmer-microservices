...
func request_FarmService_DeleteFarm_0(ctx context.Context, marshaler runtime.Marshaler, client FarmServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq DeleteFarmRequest
	var metadata runtime.ServerMetadata
...
func request_FarmService_SellChicken_0(ctx context.Context, marshaler runtime.Marshaler, client FarmServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SellChickenRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.SellChicken(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_FarmService_SellChicken_0(ctx context.Context, marshaler runtime.Marshaler, server FarmServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SellChickenRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.SellChicken(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterFarmServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FarmServiceClient) error {
	...
	mux.Handle("POST", pattern_FarmService_DeleteFarm_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/chicken_farmer.v1.FarmService/DeleteFarm", runtime.WithHTTPPathPattern("/chicken_farmer.v1.FarmService/DeleteFarm"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_FarmService_SellChicken_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/chicken_farmer.v1.FarmService/SellChicken", runtime.WithHTTPPathPattern("/v1/farm/chickens/{chicken_id}/sell"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_FarmService_SellChicken_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_FarmService_DeleteFarm_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"chicken_farmer.v1.FarmService", "DeleteFarm"}, ""))
	...
	pattern_FarmService_SellChicken_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"v1", "farm", "chickens", "chicken_id", "sell"}, ""))
...
var (
	...
	forward_FarmService_SellChicken_0 = runtime.ForwardResponseMessage
