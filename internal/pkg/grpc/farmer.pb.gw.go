...
var (
	filter_FarmerService_Login_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func request_FarmerService_Login_0(ctx context.Context, marshaler runtime.Marshaler, client FarmerServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_FarmerService_Login_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func RegisterFarmerServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server FarmerServiceServer) error {
	...
	mux.Handle("GET", pattern_FarmerService_Login_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
	...
	mux.Handle("POST", pattern_FarmerService_GrantGoldEggs_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/chicken_farmer.v1.FarmerService/GrantGoldEggs", runtime.WithHTTPPathPattern("/v1/farmer/grant-gold-eggs"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_FarmerService_SpendGoldEggs_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/chicken_farmer.v1.FarmerService/SpendGoldEggs", runtime.WithHTTPPathPattern("/v1/farmer/spend-gold-eggs"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_FarmerService_GetGoldEggs_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/chicken_farmer.v1.FarmerService/GetGoldEggs", runtime.WithHTTPPathPattern("/v1/farmer/gold-eggs"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterFarmerServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FarmerServiceClient) error {
	...
	mux.Handle("POST", pattern_FarmerService_GrantGoldEggs_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/chicken_farmer.v1.FarmerService/GrantGoldEggs", runtime.WithHTTPPathPattern("/v1/farmer/grant-gold-eggs"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_FarmerService_SpendGoldEggs_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/chicken_farmer.v1.FarmerService/SpendGoldEggs", runtime.WithHTTPPathPattern("/v1/farmer/spend-gold-eggs"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_FarmerService_GetGoldEggs_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/chicken_farmer.v1.FarmerService/GetGoldEggs", runtime.WithHTTPPathPattern("/v1/farmer/gold-eggs"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_FarmerService_GrantGoldEggs_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "farmer", "grant-gold-eggs"}, ""))

	pattern_FarmerService_SpendGoldEggs_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "farmer", "spend-gold-eggs"}, ""))

	pattern_FarmerService_GetGoldEggs_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "farmer", "gold-eggs"}, ""))
)
