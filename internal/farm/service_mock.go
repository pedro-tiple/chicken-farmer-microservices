...
// BuyFeedBag mocks base method.
func (m *MockIController) BuyFeedBag(ctx context.Context, barnID uuid.UUID, amount uint) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BuyFeedBag", ctx, barnID, amount)
	ret0, _ := ret[0].(error)
	return ret0
}

// BuyFeedBag indicates an expected call of BuyFeedBag.
func (mr *MockIControllerMockRecorder) BuyFeedBag(ctx, barnID, amount interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BuyFeedBag", reflect.TypeOf((*MockIController)(nil).BuyFeedBag), ctx, barnID, amount)
}
