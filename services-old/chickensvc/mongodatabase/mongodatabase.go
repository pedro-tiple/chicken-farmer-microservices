...
func New(_ctx context.Context) (MongoDatabase, error) {
	...
	clientOptions := options.Client().ApplyURI("mongodb://admin:password@chickensvc-mongodb:27017")
...
func (mongodb MongoDatabase) GetChickensOfFarmer(_farmerId primitive.ObjectID) ([]*chickensvc.Chicken, error) {
