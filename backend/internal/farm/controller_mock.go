...
func (m *MockIDatabase) UpdateChickenRestingUntil(ctx context.Context, chickenID uuid.UUID, day uint) error {
	m.ctrl.T.Helper()
...
func (mr *MockIDatabaseMockRecorder) UpdateChickenRestingUntil(ctx, chickenID, day interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateChickenRestingUntil", reflect.TypeOf((*MockIDatabase)(nil).UpdateChickenRestingUntil), ctx, chickenID, day)
}
