...
func request_FarmService_BuyFeed_0(ctx context.Context, marshaler runtime.Marshaler, client FarmServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq BuyFeedRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.BuyFeed(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_FarmService_BuyFeed_0(ctx context.Context, marshaler runtime.Marshaler, server FarmServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq BuyFeedRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.BuyFeed(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterFarmServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server FarmServiceServer) error {
	...
	mux.Handle("GET", pattern_FarmService_GetFarm_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/farm.v1.FarmService/GetFarm", runtime.WithHTTPPathPattern("/v1/farm"))
		if err != nil {
	...
	mux.Handle("POST", pattern_FarmService_BuyBarn_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/farm.v1.FarmService/BuyBarn", runtime.WithHTTPPathPattern("/v1/farm/barns/buy"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_FarmService_BuyFeed_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/farm.v1.FarmService/BuyFeed", runtime.WithHTTPPathPattern("/v1/farm/barns/{barn_id}/buy_feed"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_FarmService_BuyFeed_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_FarmService_BuyFeed_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_FarmService_BuyChicken_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/farm.v1.FarmService/BuyChicken", runtime.WithHTTPPathPattern("/v1/farm/chickens/buy"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_FarmService_FeedChicken_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/farm.v1.FarmService/FeedChicken", runtime.WithHTTPPathPattern("/v1/farm/chickens/{chicken_id}/feed"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_FarmService_FeedChickensOfBarn_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/farm.v1.FarmService/FeedChickensOfBarn", runtime.WithHTTPPathPattern("/v1/farm/chickens/feed-all"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterFarmServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FarmServiceClient) error {
	...
	mux.Handle("GET", pattern_FarmService_GetFarm_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/farm.v1.FarmService/GetFarm", runtime.WithHTTPPathPattern("/v1/farm"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_FarmService_BuyBarn_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/farm.v1.FarmService/BuyBarn", runtime.WithHTTPPathPattern("/v1/farm/barns/buy"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_FarmService_BuyFeed_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/farm.v1.FarmService/BuyFeed", runtime.WithHTTPPathPattern("/v1/farm/barns/{barn_id}/buy_feed"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_FarmService_BuyFeed_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_FarmService_BuyChicken_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/farm.v1.FarmService/BuyChicken", runtime.WithHTTPPathPattern("/v1/farm/chickens/buy"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_FarmService_FeedChicken_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/farm.v1.FarmService/FeedChicken", runtime.WithHTTPPathPattern("/v1/farm/chickens/{chicken_id}/feed"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_FarmService_FeedChickensOfBarn_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/farm.v1.FarmService/FeedChickensOfBarn", runtime.WithHTTPPathPattern("/v1/farm/chickens/feed-all"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_FarmService_GetFarm_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "farm"}, ""))

	pattern_FarmService_BuyBarn_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "farm", "barns", "buy"}, ""))

	pattern_FarmService_BuyFeed_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"v1", "farm", "barns", "barn_id", "buy_feed"}, ""))
	...
	pattern_FarmService_FeedChickensOfBarn_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "farm", "chickens", "feed-all"}, ""))
)
...
var (
	...
	forward_FarmService_BuyFeed_0 = runtime.ForwardResponseMessage
