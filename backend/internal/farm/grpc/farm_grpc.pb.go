...
func (c *farmServiceClient) GetFarm(ctx context.Context, in *GetFarmRequest, opts ...grpc.CallOption) (*GetFarmResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/farm.v1.FarmService/GetFarm", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *farmServiceClient) BuyBarn(ctx context.Context, in *BuyBarnRequest, opts ...grpc.CallOption) (*BuyBarnResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/farm.v1.FarmService/BuyBarn", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *farmServiceClient) BuyFeed(ctx context.Context, in *BuyFeedRequest, opts ...grpc.CallOption) (*BuyFeedResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/farm.v1.FarmService/BuyFeed", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *farmServiceClient) BuyChicken(ctx context.Context, in *BuyChickenRequest, opts ...grpc.CallOption) (*BuyChickenResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/farm.v1.FarmService/BuyChicken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *farmServiceClient) FeedChicken(ctx context.Context, in *FeedChickenRequest, opts ...grpc.CallOption) (*FeedChickenResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/farm.v1.FarmService/FeedChicken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *farmServiceClient) FeedChickensOfBarn(ctx context.Context, in *FeedChickensOfBarnRequest, opts ...grpc.CallOption) (*FeedChickensOfBarnResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/farm.v1.FarmService/FeedChickensOfBarn", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _FarmService_GetFarm_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/farm.v1.FarmService/GetFarm",
	}
...
func _FarmService_BuyBarn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/farm.v1.FarmService/BuyBarn",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _FarmService_BuyFeed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/farm.v1.FarmService/BuyFeed",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _FarmService_BuyChicken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/farm.v1.FarmService/BuyChicken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _FarmService_FeedChicken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/farm.v1.FarmService/FeedChicken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _FarmService_FeedChickensOfBarn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/farm.v1.FarmService/FeedChickensOfBarn",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
